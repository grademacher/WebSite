...
Hero.prototype.bounce = function(){
  ...
  tis.body.velocity.y = -BOUNCE_SPEED;
}
...
PlayState._handleCollisions = function () {
  this.game.physics.arcarde.collide(this.spiders, this.platforms);
  this.game.physics.arcarde.collide(this.spiders, this.enemyWalls);
...
PlayState._spawnPlatform = function (platform) {
  ...
  this._spawnEnemyWall(platform.x + sprite.width, sprite.y, 'right');
